...
//STEPPER OBJECTS
RampsStepper stepperHigher(X_STEP_PIN, X_DIR_PIN, X_ENABLE_PIN, INVERSE_X_STEPPER, J2_J3_GEAR_TEETH, MOTOR_GEAR_TEETH, MICROSTEPS, STEPS_PER_REV);
RampsStepper stepperLower(Y_STEP_PIN, Y_DIR_PIN, Y_ENABLE_PIN, INVERSE_Y_STEPPER, J2_J3_GEAR_TEETH, MOTOR_GEAR_TEETH, MICROSTEPS, STEPS_PER_REV);
RampsStepper stepperRotate(Z_STEP_PIN, Z_DIR_PIN, Z_ENABLE_PIN, INVERSE_Z_STEPPER, J1_GEAR_TEEH, MOTOR_GEAR_TEETH, MICROSTEPS, STEPS_PER_REV);
...
//Joint J1(Z_MIN_PIN, Z_DIR_PIN, Z_STEP_PIN, Z_ENABLE_PIN, INVERSE_Z_STEPPER, J1_GEAR_TEEH, MOTOR_GEAR_TEETH, MICROSTEPS, STEPS_PER_REV, Z_MIN_INPUT, Z_HOME_STEPS, HOME_DWELL, false);
//Joint J2(Y_MIN_PIN, Y_DIR_PIN, Y_STEP_PIN, Y_ENABLE_PIN, INVERSE_Y_STEPPER, J2_J3_GEAR_TEETH, MOTOR_GEAR_TEETH, MICROSTEPS, STEPS_PER_REV, Y_MIN_INPUT, Y_HOME_STEPS, HOME_DWELL, false);
//Joint J3(X_MIN_PIN, X_DIR_PIN, X_STEP_PIN, X_ENABLE_PIN, INVERSE_X_STEPPER, J2_J3_GEAR_TEETH, MOTOR_GEAR_TEETH, MICROSTEPS, STEPS_PER_REV, X_MIN_INPUT, X_HOME_STEPS, HOME_DWELL, false);
// Joint J4()

 Joint J1(stepperHigher, endstopX);
 Joint J2(stepperLower, endstopY);
 Joint J3(stepperRotate, endstopZ);
